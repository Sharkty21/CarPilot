...
from tools.finance_tools import update_finance_info
...
def test_update_finance_docstring_requires_confirmation():
    doc = update_finance_info.description or update_finance_info.__doc__ or ""
    assert "confirm" in doc.lower()
